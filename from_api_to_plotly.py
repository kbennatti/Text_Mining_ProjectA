...
# 1st time only
c.execute(
    'CREATE TABLE coinsNews(description TEXT, title TEXT, url TEXT, author TEXT, published TEXT)')  # create a table
...
trace1 = go.Scatter(x=np.array(counts), y=np.array(bitcoin), mode='markers')
data = [trace1]
